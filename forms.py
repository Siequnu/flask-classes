...
class LessonForm(FlaskForm):
	...
	online_lesson_invitation = StringField('Zoom online lesson invitation', render_kw={"placeholder": "Paste Zoom invitation here to automatically parse lesson details"})
